...
#Bob
var cl_bob : float = 0.005            # default: 0.01
var cl_bobup : float = 0.4           # default: 0.5
var cl_bobcycle : float = 0.4         # default: 0.8
var ql_bob : float = 0.006            # default: 0.012
var ql_bobup : float = 0.4            # default: 0.5
var ql_bobcycle : float = 0.3         # default: 0.6
...
#View Idle
var idlescale : float= 0.0            # default: 1.6
